...
COpenWeatherMapProvider.prototype = {
    ...
    getWeather: function () {
        ...
        if (this.debug)
        {
            ...
            console.log(self.weatherReminder.setWeatherData(json).checkWeather());
            return true;
        }
        $.ajax(this.url, {
            data: {
...
CWeatherReminder.prototype = {
    ...
    checkWeather: function () {
        ...
        // console.log(list);
        var self = this;
        // alert(JSON.stringify(this.weatherData, null, 4));
    ...
    notify: function () {
        ...
        //     '/icons/sensWind_icon.jpg',  // icon url - can be relative
...
CWeather.prototype = {
    checkWeather: function (place) {
        ...
        // this.setCache(place, weatherResult);
        // this.weatherReminder.setWeatherData(weatherResult);
        // return this.weatherReminder.checkWeather();
    },
    // setCache: function (place, result) {
    //     var cache = { result, {'life': Data.now()};
    //     this.cache[place];
    // },
    // getCache: function () {
    //
